...
public class OtpUtil {
	...
	public static String getQRBarcodeURL(String user, String host, String secret) {
		// QR코드 주소 생성
//		String format2 = "http://chart.apis.google.com/chart?cht=qr&chs=200x200&chl=otpauth://totp/solution(%s)%%3Fsecret%%3D%s&chld=H|0";
		String format2 = "otpauth://totp/"+applicationName+"(%s)?secret=%s";
		
		return String.format(format2, user, secret);
	}
}
